...
class Decoder:
  ...
  """
        O método encoder é responsável por pegar o valor do cromossomo base repassado na decodificação
        ...
        declarando-o como resultado do método deepcopy da cópia,o qual usa os parâmetros de self.
    ...
    def score(self, hyperparameters: dict) -> float:
     """
        ...
        Segundo, o try declara para que o clone do estimador usa o método fit(aptidão),com base nos valores em x e em y do 
        self, exceto quando dá erro no valor, o qual nesse caso, o valor retornado é 0.
...
"""
    ...
    A classe de inicialização declara alguns parâmetros e variáveis nos quais o funcionamento do Algoritmo
    Genético se sustenta, bem como o valor inicial de alguns deles.
...
"""
    ...
    def fit(self, X:d, y=None, *, groups=None, **fit_params):
     """
        ...
        Em caso de não existir valor  ou se ele for uma instância do método em string, os pontuadores checam o método de 
        pontuação do self, bem como seu estimador.
